 ...
 */
int
ini_getbool(const TCHAR *Section, const TCHAR *Key, int DefValue, const TCHAR *Filename)
{
 ...
 * @param Buffer      a pointer to the buffer to copy into
 * @param BufferSize  the maximum number of characters to copy
 * @aram Filename    the name and full path of the .ini file to read from
 *
 * @return            the number of characters copied into the supplied buffer
 */
int
ini_getsection(int idx, TCHAR *Buffer, int BufferSize, const TCHAR *Filename)
{
  INI_FILETYPE fp;
  int ok = 0;
